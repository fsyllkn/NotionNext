...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个想耍事儿的小白', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cbyer.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'BaiRuSi, 博客', // 网站关键词 英文逗号隔开
